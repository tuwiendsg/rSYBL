...
public class BinaryRestriction {
    ...
    protected BinaryRestriction.LeftHandSide leftHandSide;
    @XmlElement(name = "RightHandSide", required = true)
    protected BinaryRestriction.RightHandSide rightHandSide;
     ...
     *     
     */
    public BinaryRestriction.LeftHandSide getLeftHandSide() {
        return leftHandSide;
    }
     ...
     *     
     */
    public void setLeftHandSide(BinaryRestriction.LeftHandSide value) {
     ...
     *     
     */
    public BinaryRestriction.RightHandSide getRightHandSide() {
     ...
     *     
     */
    public void setRightHandSide(BinaryRestriction.RightHandSide value) {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class LeftHandSide {
    ...
    public static class RightHandSide {
         ...
         * @return
         *     possible object is
         *     {@link BinaryRestriction.RightHandSide.Metric }
         *     
         */
        public String getMetric() {
            return metric;
