...
public class ElasticityCapabilityXML {
	 @XmlAttribute(name = "ElasticityPrimitives")
	private String elasticityPrimitives = "";

	public String getElasticityPrimitives() {
		return elasticityPrimitives;
	}

	public void setElasticityPrimitives(String elasticityPrimitives) {
