...
public class UnaryRestrictionsConjunction {
	  @XmlElement(name = "UnaryRestrictionsConjunction", required = true) // the conjunction
		...
		public List<UnaryRestriction> getUnaryRestrictions() {
			return unaryRestrictions;
		}

		public void setUnaryRestrictions(List<UnaryRestriction> unaryRestrictions) {
			this.unaryRestrictions = unaryRestrictions;
		}
		public void add(UnaryRestriction unaryRestriction){
