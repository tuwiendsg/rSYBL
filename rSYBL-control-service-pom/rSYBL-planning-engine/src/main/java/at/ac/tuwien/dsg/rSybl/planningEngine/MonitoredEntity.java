...
public abstract class MonitoredEntity {
	...
	public abstract Collection<String> getMonitoredMetrics();
	public abstract void setMonitoredVar(String data, String value);
	public abstract String getMonitoredVar(String data);
}
