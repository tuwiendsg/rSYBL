 ...
 * 
 */
@WebServiceClient(name = "UserAPI", targetNamespace = "http://extility.flexiant.net", wsdlLocation = "file:/C:/Users/Georgiana/Desktop/TUWIEN_DSG_Github/control-stress-application/src/main/resources/UserAPI.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/C:/Users/Georgiana/Desktop/TUWIEN_DSG_Github/control-stress-application/src/main/resources/UserAPI.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/C:/Users/Georgiana/Desktop/TUWIEN_DSG_Github/control-stress-application/src/main/resources/UserAPI.wsdl', retrying as a local file");
